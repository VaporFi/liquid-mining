...
contract BoostFacet {
    event ClaimBoost(address indexed _user, uint256 _seasonId, uint256 _boostPoints, uint256 boostFee, uint256 tier);
    ...
    function claimBoost(uint256 boostLevel) external {
        ...
        emit ClaimBoost(msg.sender, _seasonId, _userData.boostPoints, _boostFee, tier);
    }
